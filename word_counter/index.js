...
const welcome = async () => {
    let welcomeNote = chalkAnimation.rainbow("......Word  / Character Counter......");
    await timeout();
    welcomeNote.stop();
};
await welcome();
        ...
        let countWords = await inquirer.prompt([
            {
                type: "input",
                name: "paragraph",
                message: chalk.rgb(127, 147, 217)("Enter paragraph to count the words !"),
            },
        ]);
        ...
        let countChar = await inquirer.prompt([
            {
                type: "input",
                name: "character",
                message: chalk.rgb(127, 147, 217)("Enter paragraph to count the characters !"),
            },
        ]);
